...
//  judgeJurisdiction();
    ...
    function deelwithFace() {
        ...
        oh1[1].querySelector("span").innerHTML="学情周报（"+ClassReportData.cover.subjectname+"）";
        //学号，班级
...
function bindUrlTOa(){
    var pdfUrl="http://115.29.220.75:8080/WKPDFReport/import?type="+12+"&key=id&value="+	     reportId+"&filename="+"RC"+reportId;
    loadPdf.href=pdfUrl;
