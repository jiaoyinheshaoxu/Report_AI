...
function delayload(contentType,perId){
    ...
    function gaiyao(){
        ...
        var rank=thisTestScore.classSort;
		var rank2=thisTestScore.gradeSort;
        var Avg=thisTestScore.classAvg;
        var Avg2=thisTestScore.gradeAvg;
        $('.GYDF_2').show();
        $('.GYDF_2_gAvr').show();
        ...
        $('.GYDF_2_gAvr span:nth-child(2)').show();
		$('.GYDF_2_gRank span:nth-child(2)').text('年级排名：'+rank2+'名')
        $('.GYDF_2_gAvr span:nth-child(2)').text('年级平均分：'+Avg2+'分');
        //1-2测试评价
...
function bindUrlTOa(){
    var pdfUrl="http://115.29.220.75:8080/WKPDFReport/import?type="+15+"&key=id&value="+	     reportId+"&filename="+"RS"+reportId;
